...
public class GoToViewOneNewsPage implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			request.setAttribute(RequestParam.KEY_TO_NEWS_ATTRIBUTE, RequestParam.VALUE_TO_VIEW_NEWS_ATTRIBUTE);
			request.setAttribute(RequestParam.KEY_TO_VIEW_NEWS_OBJECT, news);
